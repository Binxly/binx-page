---
title: 'Ghosts in the EFI - My Windows 11 Bootloader Brawl'
publishedAt: '2025-04-24'
summary: 'Resolving problems with EFI partitions in a dual boot system.'
tag: 'edu'
---

# Ghosts in the EFI - My Windows 11 Bootloader Brawl
...
```bash
dism /Get-WimInfo /WimFile:D:\sources\install.swm /SWMFile:D:\sources\install*.swm
```
